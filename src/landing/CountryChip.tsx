  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="font-display font-bold text-[14px] leading-tight text-white">{name}</div>
        <div className="text-[12px] text-slate-400 mt-0.5">{meta}</div>
      </div>
      <button
        onClick={onClear}
        aria-label="Clear selection"
        className="ml-1 w-7 h-7 rounded-full hover:bg-white/[0.06] grid place-items-center text-slate-400 hover:text-slate-200"
      >
