  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="font-display font-bold text-[14px] leading-tight text-ink-900">{name}</div>
        <div className="text-[12px] text-slate-500 mt-0.5">{meta}</div>
      </div>
      <button
        onClick={onClear}
        aria-label="Clear selection"
        className="ml-1 w-7 h-7 rounded-full hover:bg-ink-900/[0.06] grid place-items-center text-slate-500 hover:text-ink-900"
      >
