...
export function GlobeCanvas({ selected, pin, onPickCountry, onUnknownCountry }: Props) {
  ...
  const labelHtml = useMemo(
    () => (d: Feature) => {
      ...
      if (supported) {
        return `<div style="background:rgba(8,13,28,.94);padding:8px 12px;border-radius:10px;border:1px solid rgba(255,255,255,.08);font-family:Inter,sans-serif;color:#e7ecf5;letter-spacing:-.005em;">
